...
function LiveCamera() {
  ...
  const detectFrame = async () => {
    ...
    // Prevent multiple YOLO requests from running at the same time.
      ...
      async (blob) => {
        ...
        try {
          ...
          if (data.success) {
            ...
            // Keep previous successful detections.
            setDetectionStatus('ONLINE')
          }
        } catch (error) {
          console.error(
          ...
          // Render may take some time to respond.
          // Keep the camera and previous detection state.
        } finally {
          detectingRef.current = false
        }
      },
  ...
  useEffect(() => {
    ...
    // Send one frame every 3 seconds.
    // This reduces CPU/network pressure on Render.
      ...
      <div className="video-wrap">
        ...
        {!cameraOn && (
          <div className="video-overlay">
            ...
            {!cameraError && (
              <span>
                Please allow camera permission to
  ...
  if (!incident) {
    return (
      <section className="card incident-card empty">
        ...
        <p>
          No active incident is currently being
...
export default function App() {
  ...
  async function handleAction(
    ...
    try {
      ...
      alert(
        'Backend action failed. Please check the FastAPI server.'
      )
    }
  }
